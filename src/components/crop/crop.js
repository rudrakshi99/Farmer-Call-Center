      ...
      <section className="">
        <div className="grid place-items-center my-14  ">
          <div className="container bg-gray-100 p-10 grid place-items-center mt-14  ">
            <p className="text-2xl font-medium text-green-600 my-12">Predict the best crop to plant<br /></p>
            ...
            } className="w-3/5 my-2 " type="text" placeholder="Enter the value of nitrogen" />
            <input
              onChange={
                (e) => {
              ...
              className="w-3/5 my-2" type="text" placeholder="Enter the value of Phosphorus" />
            <input
              onChange={
                (e) => {
              ...
              className="w-3/5 my-2" type="text" placeholder="Enter the value of Potassium" />
            <input
              onChange={
                (e) => {
              ...
              className="w-3/5 my-2" type="text" placeholder="Enter the soil ph" />
            <input
              onChange={
                (e) => {
                  setRain(e.target.value);
                }
              }className="w-3/5 my-2" type="text" placeholder="Enter the rainfall gauge" />
            <input
              onChange={
                (e) => {
              ...
              className="w-3/5 my-2" type="text" placeholder="Enter your city" />
        ...
        <div>
          ...
          {prediction !== '' ? <div className="grid place-items-center my-14 text-center ">
            <p className="font-bold my-3">Crop Predicted: </p>{prediction}
          </div> : <div></div>}
        </div>
      </section>
      <Footer />
